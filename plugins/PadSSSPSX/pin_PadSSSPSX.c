...
static void SetDefaultConfig (void)
{
	...
	global.config.buttons[0][K_XBOX_LTHUMB] = PSX_PAD_L3;
	global.config.buttons[0][K_XBOX_RTHUMB] = PSX_PAD_R3;
#endif
...
static void LoadConfig (void) // TODO : Support Pad 2 as well
{
	...
	global.config.buttons[0][XboxConfigs_GetInt("controls.square")] = PSX_PAD_SQUARE;
	global.config.buttons[0][XboxConfigs_GetInt("controls.dpadup")] = PSX_PAD_UP;
	global.config.buttons[0][XboxConfigs_GetInt("controls.dpaddown")] = PSX_PAD_DOWN;
	global.config.buttons[0][XboxConfigs_GetInt("controls.dpadleft")] = PSX_PAD_LEFT;
	global.config.buttons[0][XboxConfigs_GetInt("controls.dpadright")] = PSX_PAD_RIGHT;
	global.config.buttons[0][XboxConfigs_GetInt("controls.select")] = PSX_PAD_SELECT;
	global.config.buttons[0][XboxConfigs_GetInt("controls.start")] = PSX_PAD_START;
	global.config.buttons[0][XboxConfigs_GetInt("controls.l1")] = PSX_PAD_L1;
	global.config.buttons[0][XboxConfigs_GetInt("controls.r1")] = PSX_PAD_R1;
	global.config.buttons[0][XboxConfigs_GetInt("controls.l2")] = PSX_PAD_L2;
