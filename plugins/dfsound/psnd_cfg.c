...
#ifdef _XBOX
 iVolume = 2;
 iXAPitch = XboxConfigs_GetBool("sound.xapitch");
 iSPUIRQWait = XboxConfigs_GetBool("sound.spuirqwait");
 iUseTimer = XboxConfigs_GetInt("sound.mode");
 iUseReverb = XboxConfigs_GetInt("sound.usereverb");
 iUseInterpolation = XboxConfigs_GetInt("sound.interpolation");
 iDisStereo = XboxConfigs_GetBool("sound.stereo");
 iFreqResponse = XboxConfigs_GetBool("sound.freqresponse");
#else
 iVolume=2;
 iXAPitch=0;
 iSPUIRQWait=1;
